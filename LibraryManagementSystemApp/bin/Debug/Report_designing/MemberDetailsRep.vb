...
Public Class MemberDetailsRep
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LibraryManagementSystemApp.MemberDetailsRep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMemberDetailsRep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MemberDetailsRep = New MemberDetailsRep()
        rpt.Site = Me.Site
        Return rpt
    End Function

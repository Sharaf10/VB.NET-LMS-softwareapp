...
Public Class SupplierDetailsRep
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LibraryManagementSystemApp.SupplierDetailsRep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSupplierDetailsRep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SupplierDetailsRep = New SupplierDetailsRep()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class ReturnDetailsRep
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LibraryManagementSystemApp.ReturnDetailsRep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReturnDetailsRep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReturnDetailsRep = New ReturnDetailsRep()
        rpt.Site = Me.Site
        Return rpt
    End Function

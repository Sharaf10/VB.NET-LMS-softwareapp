...
Public Class StaffDetailsRep
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LibraryManagementSystemApp.StaffDetailsRep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStaffDetailsRep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StaffDetailsRep = New StaffDetailsRep()
        rpt.Site = Me.Site
        Return rpt
    End Function

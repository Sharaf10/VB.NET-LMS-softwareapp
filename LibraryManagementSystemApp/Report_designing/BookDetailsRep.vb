...
Public Class BookDetailsRep
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LibraryManagementSystemApp.BookDetailsRep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBookDetailsRep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BookDetailsRep = New BookDetailsRep()
        rpt.Site = Me.Site
        Return rpt
    End Function
